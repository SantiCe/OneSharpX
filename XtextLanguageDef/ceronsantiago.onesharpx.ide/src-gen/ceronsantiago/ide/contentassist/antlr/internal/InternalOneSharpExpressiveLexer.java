...
public class InternalOneSharpExpressiveLexer extends Lexer {
    ...
    public final void mRULE_LETTER() throws RecognitionException {
        try {
            // InternalOneSharpExpressive.g:2205:22: ( ( 'A' .. 'Z' | 'a' .. 'z' | '_' ) )
            // InternalOneSharpExpressive.g:2205:24: ( 'A' .. 'Z' | 'a' .. 'z' | '_' )
            {
    ...
    public final void mRULE_DIGIT() throws RecognitionException {
        try {
            // InternalOneSharpExpressive.g:2207:21: ( '0' .. '9' )
            // InternalOneSharpExpressive.g:2207:23: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOneSharpExpressive.g:2209:10: ( '1' .. '9' ( RULE_DIGIT )* )
            // InternalOneSharpExpressive.g:2209:12: '1' .. '9' ( RULE_DIGIT )*
            {
            matchRange('1','9'); 
            // InternalOneSharpExpressive.g:2209:21: ( RULE_DIGIT )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOneSharpExpressive.g:2211:9: ( ( RULE_LETTER )+ ( RULE_LETTER | RULE_DIGIT | '#' )* )
            // InternalOneSharpExpressive.g:2211:11: ( RULE_LETTER )+ ( RULE_LETTER | RULE_DIGIT | '#' )*
            {
            // InternalOneSharpExpressive.g:2211:11: ( RULE_LETTER )+
            int cnt2=0;
            loop2:
            do {
                int alt2=2;
            ...
            // InternalOneSharpExpressive.g:2211:24: ( RULE_LETTER | RULE_DIGIT | '#' )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_OS() throws RecognitionException {
        try {
            int _type = RULE_OS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOneSharpExpressive.g:2213:9: ( '\"' ( '1' | '#' )+ '\"' )
            // InternalOneSharpExpressive.g:2213:11: '\"' ( '1' | '#' )+ '\"'
            {
            match('\"'); 
            // InternalOneSharpExpressive.g:2213:15: ( '1' | '#' )+
            int cnt4=0;
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOneSharpExpressive.g:2215:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalOneSharpExpressive.g:2215:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalOneSharpExpressive.g:2215:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt5=0;
            loop5:
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOneSharpExpressive.g:2217:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalOneSharpExpressive.g:2217:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalOneSharpExpressive.g:2217:24: ( options {greedy=false; } : . )*
            loop6:
            do {
                int alt6=2;
                ...
                switch (alt6) {
            	case 1 :
            	    // InternalOneSharpExpressive.g:2217:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOneSharpExpressive.g:2219:17: ( ( '//' | ';' ) (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalOneSharpExpressive.g:2219:19: ( '//' | ';' ) (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            // InternalOneSharpExpressive.g:2219:19: ( '//' | ';' )
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    // InternalOneSharpExpressive.g:2219:20: '//'
                    {
                    match("//"); 
                    ...
                    break;
                case 2 :
                    // InternalOneSharpExpressive.g:2219:25: ';'
                    {
                    match(';'); 
            ...
            // InternalOneSharpExpressive.g:2219:30: (~ ( ( '\\n' | '\\r' ) ) )*
            loop8:
            do {
                int alt8=2;
            ...
            // InternalOneSharpExpressive.g:2219:46: ( ( '\\r' )? '\\n' )?
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // InternalOneSharpExpressive.g:2219:47: ( '\\r' )? '\\n'
                    {
                    // InternalOneSharpExpressive.g:2219:47: ( '\\r' )?
                    int alt9=2;
    ...
    static final String[] DFA11_transitionS = {
            "\2\17\2\uffff\1\17\22\uffff\1\17\1\uffff\1\16\5\uffff\1\6\1\7\2\uffff\1\10\2\uffff\1\20\1\uffff\11\14\1\11\1\21\5\uffff\32\15\4\uffff\1\15\1\uffff\1\15\1\13\1\3\1\15\1\4\1\15\1\5\1\15\1\12\11\15\1\2\3\15\1\1\3\15",
            "\1\22",
            "\1\24\2\uffff\1\23",
            "\1\25",
            "\1\26",
