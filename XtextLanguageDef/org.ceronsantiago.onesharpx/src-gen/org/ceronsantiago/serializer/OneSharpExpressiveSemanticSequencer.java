...
public class OneSharpExpressiveSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	/**
	 * Constraint:
	 *     (register=IdOrInt caseOne+=Command* caseSharp+=Command*)
	 */
	...
	/**
	 * Constraint:
	 *     (register=IdOrInt caseOne+=Command* caseSharp+=Command* caseEmpty+=Command*)
	 */
	...
	/**
	 * Constraint:
	 *     (register=IdOrInt word=IdOrString)
	 */
	protected void sequence_Write(EObject context, Write semanticObject) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getWriteAccess().getRegisterIdOrIntParserRuleCall_2_0(), semanticObject.getRegister());
		feeder.accept(grammarAccess.getWriteAccess().getWordIdOrStringParserRuleCall_3_0(), semanticObject.getWord());
		feeder.finish();
	}
}
