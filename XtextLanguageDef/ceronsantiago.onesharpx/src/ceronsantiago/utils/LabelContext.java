...
public class LabelContext {
	 ...
	 */
	public ArrayList<LabelContext> children = new ArrayList<>();
	 ...
	 * 
	 */
	public LabelContext parent;
	
	public LabelContext(CommandBlock block, int startingLine, LabelContext parent){
		this.parent = parent;
