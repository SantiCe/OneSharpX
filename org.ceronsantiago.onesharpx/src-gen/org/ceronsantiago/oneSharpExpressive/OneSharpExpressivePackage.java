...
public interface OneSharpExpressivePackage extends EPackage
{
  ...
  /**
   * Returns the meta object for the containment reference list '{@link org.ceronsantiago.oneSharpExpressive.LoopCase#getCaseEmpty <em>Case Empty</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Case Empty</em>'.
   * @see org.ceronsantiago.oneSharpExpressive.LoopCase#getCaseEmpty()
   * @see #getLoopCase()
   * @generated
   */
  EReference getLoopCase_CaseEmpty();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference LOOP_CASE__CASE_EMPTY = eINSTANCE.getLoopCase_CaseEmpty();
