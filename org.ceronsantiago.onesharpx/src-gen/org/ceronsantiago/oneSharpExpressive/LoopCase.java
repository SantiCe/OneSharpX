...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Loop Case</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link org.ceronsantiago.oneSharpExpressive.LoopCase#getRegister <em>Register</em>}</li>
 *   <li>{@link org.ceronsantiago.oneSharpExpressive.LoopCase#getCaseOne <em>Case One</em>}</li>
 *   <li>{@link org.ceronsantiago.oneSharpExpressive.LoopCase#getCaseSharp <em>Case Sharp</em>}</li>
 *   <li>{@link org.ceronsantiago.oneSharpExpressive.LoopCase#getCaseEmpty <em>Case Empty</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.ceronsantiago.oneSharpExpressive.OneSharpExpressivePackage#getLoopCase()
 * @model
 * @generated
 */
public interface LoopCase extends EObject
{
  /**
   ...
   * @see org.ceronsantiago.oneSharpExpressive.OneSharpExpressivePackage#getLoopCase_Register()
   * @model
   * @generated
   */
  String getRegister();
  ...
  /**
   * Sets the value of the '{@link org.ceronsantiago.oneSharpExpressive.LoopCase#getRegister <em>Register</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.ceronsantiago.oneSharpExpressive.OneSharpExpressivePackage#getLoopCase_CaseOne()
   ...
   * @see org.ceronsantiago.oneSharpExpressive.OneSharpExpressivePackage#getLoopCase_CaseSharp()
   * @model containment="true"
   * @generated
   */
   ...
   * @see org.ceronsantiago.oneSharpExpressive.OneSharpExpressivePackage#getLoopCase_CaseEmpty()
   * @model containment="true"
   * @generated
   */
